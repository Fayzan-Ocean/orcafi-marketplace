...
import Logo from "./../../public/images/orcafi-white.png";
import WhiteLogo from "./../../public/images/orcafi.png";
...
import { useDisconnect ,useSignMessage, useNetwork} from 'wagmi'
...
export default function Header01() {
  ...
  return (
    <>
      ...
      <header className={`flex  flex-wrap js-page-header  top-0  z-20  bg-transparent fixed  backdrop-blur transition-colors  w-full ${scrolled ? 'bg-transparent  pt-4' : 'backdrop-blur pt-4'}`} >
        <div className={`flex items-center justify-around xl:mx-24 rounded-full    w-full pr-10`} >
          ...
          <form
            action="search"
            className="relative ml-14 mr-8 hidden basis-5/12 lg:block xl:ml-[10%] w-full rounded-xl"
          >
            <input
              type="search"
              className="bg-[#E6E6E6] text-jacarta-700 placeholder-jacarta-500 focus:ring-accent  w-full rounded-sm border-none py-[0.6875rem] px-4 pl-10 dark:border-transparent dark:bg-white/[.15] dark:text-white font-bold dark:placeholder-white"
              placeholder="Search"
            />
          ...
          {address ? <>  <div className="js-nav-dropdown group-dropdown relative">
